...
const static uint8_t _ibeacon_proximity_uuid[16] = {0xe2, 0xc5, 0x6d, 0xb5, 0xdf, 0xfb, 0x48, 0xd2, 0xb0, 0x60, 0xd0, 0xf5, 0xa7, 0x10, 0x96, 0xe0};
...
static void app_start_advertising(void)
{
    ...
    adv_data.advertising_data[4] = 0xFF;    //# Manufacturer specific data AD type
    adv_data.advertising_data[5] = 0x4C;    //# Company identifier code (0x004C == Apple)
    adv_data.advertising_data[6] = 0x00;
    adv_data.advertising_data[7] = 0x02;    //# Byte 0 of iBeacon advertisement indicator
    adv_data.advertising_data[8] = 0x15;    //# Byte 1 of iBeacon advertisement indicator

    memcpy(adv_data.advertising_data+9, _ibeacon_proximity_uuid, 16);

    adv_data.advertising_data[25] = 0x0;    //# major
    adv_data.advertising_data[26] = 0x1;    
    adv_data.advertising_data[27] = 0x0;    //# minor
    adv_data.advertising_data[28] = 0x0;
    adv_data.advertising_data[29] = 0xC5;    //# The 2's complement of the calibrated Tx Power

    adv_data.advertising_data_length = 30;
